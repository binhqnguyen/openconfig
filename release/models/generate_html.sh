...
rm all_yangs.txt
for i in */*.yang; do echo $i >> all_yangs.txt; done
pyang -f jstree ietf-yang-types@2013-07-15.yang ietf-interfaces.yang iana-if-type@2014-05-08.yang ietf-inet-types@2013-07-15.yang network-topology@2013-10-21.yang yang-ext.yang $(cat all_yangs.txt) -W none -p ${DIR} > index.html
#pyang -f jstree ietf-yang-types@2013-07-15.yang ietf-interfaces.yang iana-if-type@2014-05-08.yang ietf-inet-types@2013-07-15.yang network-topology@2013-10-21.yang yang-ext.yang $(cat resolved_yangs.txt) -W none -p ${DIR} > index.html
